...
- CLI binary integration tests, help snapshot, and architecture-aligned `status: ok|error` JSON envelope tests are now part of the current tree and are included in the next clean validation.
